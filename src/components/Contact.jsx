...
const Contact = () => {
	return (
		<section id="contact" className="section">
			<div className="container lg:grid lg:items-stretch lg:grid-cols-[1fr,3fr]">
				<div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
					<h2 className="headline-2 lg:max-w-[12ch]">CONTACT</h2>
					...
					<div className="flex flex-col gap-2 mt-auto items-start">
						<p className="text-zinc-400 mt-16 max-w-[50ch] lg:max-w-[30ch]">
							Explore my professional journey and network with me!
						</p>
						...
						<div className="flex items-center gap-2 mt-auto">
							{socialLinks.map(({ href, icon }, key) => (
								<a
									...
									href={href}
									target="_blank"
									className="w-32 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
								>
									{icon}
								</a>
							))}
				...
				<form
					action="https://getform.io/f/bmddvxva"
					method="POST"
